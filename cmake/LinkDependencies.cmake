function(LinkDependencies)
  ...
  SET(USE_GLM             FALSE)
  SET(USE_METASTUFF       FALSE)
  SET(USE_INIH            FALSE)
  SET(USE_MESHDECIMATION  FALSE)
  SET(USE_POLYPARTITION   FALSE)
  ...
  IF(${VIOLET_CONFIG_ENGINE})
    ...
    SET(USE_GLM TRUE)
    SET(USE_METASTUFF TRUE)
    SET(USE_INIH TRUE)
    SET(USE_MESHDECIMATION TRUE)
    SET(USE_POLYPARTITION TRUE)
    SET(USE_SOLOUD TRUE)
    SET(USE_STB TRUE)
  ...
  IF(${USE_METASTUFF})
    ADD_LIBRARY(meta-stuff INTERFACE)
    TARGET_INCLUDE_DIRECTORIES(meta-stuff INTERFACE "deps/MetaStuff/include")
  ENDIF()
  ...
  IF(${USE_POLYPARTITION})
    SET(PolyPartitionSources
      "deps/polypartition/src/polypartition.h"
      "deps/polypartition/src/polypartition.cpp")
    ADD_LIBRARY(poly-partition ${PolyPartitionSources})
    TARGET_INCLUDE_DIRECTORIES(poly-partition INTERFACE "deps/polypartition/src")
    SetSolutionFolder("deps/math" poly-partition)
  ENDIF()
