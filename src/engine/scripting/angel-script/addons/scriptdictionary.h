...
typedef lambda::String dictKey_t;
...
#if AS_CAN_USE_CPP11
typedef lambda::UnorderedMap<dictKey_t, AS_NAMESPACE_QUALIFIER CScriptDictValue> dictMap_t;
#else
typedef lambda::Map<dictKey_t, AS_NAMESPACE_QUALIFIER CScriptDictValue> dictMap_t;
#endif
