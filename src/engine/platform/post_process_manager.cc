...
namespace lambda
{
  namespace platform
  {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void ShaderPass::setEnabled(bool enabled)
    {
      enabled_ = enabled;
    }
    ...
    bool ShaderPass::getEnabled() const
    {
      return enabled_;
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		void ShaderPass::metaSetName(Name name)
		{
			name_ = name;
		}

		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		void ShaderPass::metaSetShader(asset::VioletShaderHandle shader)
		{
			shader_ = shader;
		}

		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		void ShaderPass::metaSetInputs(const Vector<RenderTarget>& inputs)
		{
			inputs_ = inputs;
		}

		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		void ShaderPass::metaSetOutputs(const Vector<RenderTarget>& outputs)
		{
			outputs_ = outputs;
		}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void RenderTarget::metaSetRenderScale(float render_scale)
	{
		render_scale_ = render_scale;
	}

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void RenderTarget::metaSetTexture(asset::VioletTextureHandle texture)
	{
		texture_ = texture;
	}

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void RenderTarget::metaSetName(Name name)
	{
		name_ = name;
	}

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void RenderTarget::metaSetIsBackBuffer(bool is_back_buffer)
	{
		is_back_buffer_ = is_back_buffer;
	}

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void RenderTarget::metaSetFromTexture(bool from_texture)
	{
		from_texture_ = from_texture;
	}
  }
