...
namespace lambda
{
	namespace platform
	{
		...
		public:
			...
			void metaSetRenderScale(float render_scale);
			void metaSetTexture(asset::VioletTextureHandle texture);
			void metaSetName(Name name);
			void metaSetIsBackBuffer(bool is_back_buffer);
			void metaSetFromTexture(bool from_texture);
